...
<nav class="navbar navbar-expand-lg bg-white shadow sticky-top " data-bs-theme="light">
    <div class="container">
        <a class="navbar-brand " href="{{route('homepage')}}"><img style="width: auto; height: 80px " src="{{asset('image/logo-jobsearch.png')}}" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item ">
                    <a class="nav-link {{ request()->routeIs('homepage') ? 'active fw-bold text-primary' : '' }}" 
   href="{{ route('homepage') }}">
   Trang Chủ
</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('help') ? 'active fw-bold text-primary' : '' }}" 
   href="{{ route('help') }}">
   Trợ Giúp
</a>
                </li>
   ...
   Liên Hệ
                ...
                <li class="nav-item">
    <a class="nav-link {{ request()->routeIs('blog') ? 'active fw-bold text-primary' : '' }}" 
   href="{{ route('blog') }}">
   Blog
</a>
</li>
            ...
            <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-start mt-md-4 mt-3">
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-center justify-content-md-start">
                        <h1 style="font-family: Inter, sans-serif; font-size: 30px; color: white;" >JOB SEARCH</h1>
                    </div>
                    <div class="col-12 ">
                        <div class="row d-flex justify-content-center justify-content-md-start mb-3 mt-2">
                            <div class="col-2">
                                <a href="" target="_blank"><i class="fa-brands fa-facebook fa-xl" style="color: #ffffff;"></i></a>
                            </div>
                            <div class="col-2">
                                <a href="" target="_blank"><i class="fa-brands fa-github fa-xl" style="color: #ffffff;"></i></a>
                            </div>
                            <div class="col-2">
                                <a href="" target="_blank"> <i class="fa-brands fa-youtube fa-xl" style="color: #ffffff;"></i></a>
                            </div>
                        </div>
