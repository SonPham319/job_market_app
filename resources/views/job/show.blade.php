...
@section('content')
    ...
    @endif
    <img src="{{ asset('storage/' . $listing->feature_image) }}" style="width: 100%; height: 17vw;" alt="Ảnh bìa">
...
<div class="container">
    ...
    <div class=" row">
        <div class="col-12 d-flex justify-content-center justify-content-md-start">
          <img class="border-1"
     style="margin-top: -3vw; border-radius: 100px; height: 150px; box-shadow: rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px;"
     src="{{ asset('storage/' . $listing->profile->profile_pic) }}"
     alt="Logo công ty">
        </div>
